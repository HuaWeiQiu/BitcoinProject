...
var toggleIndex=function(){var t=$(".kp-index"),e=t.offset();e.left<0?t.css("left",0):t.css("left","-100%")};$(function(){$("pre").each(function(){$(this).addClass("prettyprint")}),prettyPrint()}),Array.prototype.shuffle=function(t){for(var e,r,n=this,f=n.slice(0),o=n.length,s=o-t;o-- >s;)r=Math.floor((o+1)*Math.random()),e=f[r],f[r]=f[o],f[o]=e;return f.slice(s)};