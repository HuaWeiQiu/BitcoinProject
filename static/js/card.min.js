        ...
        function t() {
            for (var n = window.PR_SHOULD_USE_CONTINUATION ? c.now() + 250 : 1 / 0; d < r.length && c.now() < n; d++) {
                ...
                if (i.indexOf("prettyprint") >= 0) {
                    ...
                    h || ((h = (h = a.className.match(/\blinenums\b(?::(\d+))?/)) ? h[1] && h[1].length ? +h[1] : !0 : !1) && s(a, h), u = {
                        g: i,
                        h: a,
                        i: h
                    }, l(u))
...
$(function () {
    ...
    for (var e, r, n = this, f = n.slice(0), o = n.length, s = o - t; o-- > s;) r = Math.floor((o + 1) * Math.random()), e = f[r], f[r] = f[o], f[o] = e;
    return f.slice(s)
};